...
/* harmony import */ var _shared_services_fuzzy_api_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./shared/services/fuzzy-api.service */ "./src/app/shared/services/fuzzy-api.service.ts");
/* harmony import */ var _components_default_default_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./components/default/default.component */ "./src/app/components/default/default.component.ts");
/* harmony import */ var _components_custom_custom_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/custom/custom.component */ "./src/app/components/custom/custom.component.ts");
/* harmony import */ var _shared_directives_number_only_directive__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./shared/directives/number-only.directive */ "./src/app/shared/directives/number-only.directive.ts");
/* harmony import */ var _shared_services_custom_toast_service__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./shared/services/custom-toast.service */ "./src/app/shared/services/custom-toast.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _components_default_default_component__WEBPACK_IMPORTED_MODULE_18__["DefaultComponent"],
                _components_custom_custom_component__WEBPACK_IMPORTED_MODULE_19__["CustomComponent"],
                _shared_directives_number_only_directive__WEBPACK_IMPORTED_MODULE_20__["NumberOnlyDirective"]
            ],
            imports: [
            ...
            providers: [_shared_services_fuzzy_api_service__WEBPACK_IMPORTED_MODULE_17__["FuzzyApiService"], primeng_components_common_messageservice__WEBPACK_IMPORTED_MODULE_16__["MessageService"], _shared_services_custom_toast_service__WEBPACK_IMPORTED_MODULE_21__["CustomToastService"]],
...
var CustomComponent = /** @class */ (function () {
    function CustomComponent(fuzzyApiService, formBuilder, customToastService) {
        ...
        this.selectedPhoneticValue = ['levenshtein'];
...
var DefaultComponent = /** @class */ (function () {
    function DefaultComponent(fuzzyApiService, customToastService) {
        this.fuzzyApiService = fuzzyApiService;
        this.customToastService = customToastService;
        this.txtSearch = '';
        this.txtAreaJSON = '';
    ...
    DefaultComponent.prototype.loadDefaultResults = function () {
        var _this = this;
        var value = this.selectedPhoneticValue[0] === '' ? 'fuzzball' : this.selectedPhoneticValue;
        var options = {
            'searchStr': this.txtSearch,
            'name': value,
            'isCustomJson': this.selectedCustomJsonValue,
